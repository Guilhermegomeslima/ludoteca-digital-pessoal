...
const bibliotecaJogos = [
    ...
    { titulo: "Samurai Warriors 4 DX", desenvolvedora: "Omega Force", ano: 2019, genero: "Musou", plataforma: "PC (Steam)", tempoJogo: "41h", conquistas: { obtidas: 41, total: 54 }, notas: { mecanica: 93, enredo: 87, estetica: 93, retencao: 92, feeling: 97 }, notaFinal: 92.4 },
    ...
    { titulo: "Metal Gear Solid 3: Snake Eater", desenvolvedora: "Konami", ano: 2004, genero: "Stealth", plataforma: "PS2", tempoJogo: "Incontáveis horas", conquistas: null, notas: { mecanica: 98, enredo: 98, estetica: 94, retencao: 93, feeling: 99 }, notaFinal: 96.4, audio: "audio/snake-eater.mp3", anotacao: "Roda perfeito no PCSX2. Obra-prima absoluta." },
    ...
    { titulo: "Resident Evil 5", desenvolvedora: "Capcom", ano: 2009, genero: "Ação / Terror", status: "Jogando", plataforma: "Xbox 360", tempoJogo: "Campanha incompleta", conquistas: null, notas: { mecanica: 88, enredo: 89, estetica: 86, retencao: 86, feeling: 87 }, notaFinal: 87.2 },
...
const extrairTempo = (texto) => {
    ...
    if (lower.includes('razoável')) return 15;
    if (lower.includes('poucas')) return 8;
